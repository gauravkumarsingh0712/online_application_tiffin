 ...
 */
public class DeleteJsonRequest extends JsonObjectRequest {
    LocalModel localModel = null;

    public DeleteJsonRequest(String url, String jsonData, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener) {

        super(Method.DELETE, url, jsonData, listener, errorListener);
